...
class CardOverlay: UIView {
    ...
    private func createLeftOverlay() {
        let leftTextView = TinderCardOverlayLabelView(withTitle: "MISS",
                                                      color: .sampleRed,
    ...
    private func createUpOverlay() {
        let upTextView = TinderCardOverlayLabelView(withTitle: "SUPA HEAT",
                                                    color: .sampleBlue,
    ...
    private func createRightOverlay() {
        let rightTextView = TinderCardOverlayLabelView(withTitle: "FIRE",
                                                       color: .sampleGreen,
                                                       rotation: -CGFloat.pi / 10)
